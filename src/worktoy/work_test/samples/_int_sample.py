"""
IntSample subclasses 'BaseSample' and provides 'int' samples.
"""
#  AGPL-3.0 license
...
class IntSample(BaseSample):
  ...
  @minVal.SET
  def _setMinVal(self, value: int) -> None:
    self.__min_value__ = value

  @maxVal.SET
  def _setMaxVal(self, value: int) -> None:
    self.__max_value__ = value
