...
NOT parse docstrings as markup. Every page is one source file shown
through 'literalinclude' as highlighted Python, generated by
docs/_gen.py and wired into a navigation tree.
...
# ============================================================
#
# No extensions are needed. 'literalinclude' and 'toctree' are part
# of Sphinx / docutils core. We deliberately do NOT load autodoc,
# autosummary, or napoleon.
extensions = []
