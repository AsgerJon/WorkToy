...
All contributions are, without exception, licensed under the Apache-2.0 license
upon submission.
...
contributions under the Apache-2.0 license. The project previously used
the copyleft AGPL-3.0 license, but moved to permissive Apache-2.0 once it
became clear that copyleft did not prevent the use it was meant to
prevent (ingestion into model training data), while it did deter
legitimate adoption. See the changelog for the full rationale.
